...
Merge conflicts don't tell you what either branch was trying to do. `git wtf merge` figures it out, keeps both, and explains every decision before touching a single file.
